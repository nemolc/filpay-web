    ...
    <el-container>
          ...
          <el-menu :default-active="activerouter" @select="handleOpen">
            ...
            <div v-else-if="activerouteType == 'documents'">
              <el-sub-menu index="1">
                ...
                <el-menu-item-group>
                  <el-menu-item index="/documents/FILPAY"><b
                      :class="activerouter == '/documents/FILPAY' ? 'chooseColor' : ''"></b>关于FILPAY</el-menu-item>
            ...
            <div v-else>
              ...
              <el-sub-menu index="2">
                ...
                <el-menu-item-group>
                  <el-menu-item index="/initiateProposal"><b
                      :class="activerouter == '/initiateProposal' ? 'chooseColor' : ''"></b>发起提案</el-menu-item>
                  <el-menu-item index="/viewProposal"><b
                      :class="activerouter == '/viewProposal' ? 'chooseColor' : ''"></b>查看提案</el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
      ...
      <el-container>
        <el-main>
          ...
          <router-view :key="datakey" style="margin-top: 26px;">
          </router-view>
        </el-main>
      </el-container>
    </el-container>
